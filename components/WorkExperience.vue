            ...
            <div class="relative">
                ...
                <div class="px-5 ml-14 md:ml-[350px]">
                    <ul class="list-disc text-xl leading-10 italic">
                        ...
                        <li>Forum host: Building beautiful friendships, saying no to school violence</li>
                        <li>MC of the historical and cultural event at school</li>
                        <li>MC of the 2024 school year closing ceremony </li>
                        <li>Character experience of a PTP news program</li>
                    </ul>
                </div>
            </div>
                ...
                <div class="px-5" data-aos="flip-right">
                    <ul class="list-disc text-xl leading-9 text-[#dbb055]">
                        ...
                        <li>Coordinated seamlessly with a well-known KOL, model, and also a my shool’s alumni, ensuring
                            their participation added value to the ceremony.</li>
                        <li>Developed strong communication skills by interacting with the celebrity guest and managing
                            the event’s flow.</li>
                        <li>Contributed to the overall success of the ceremony, making it a meaningful celebration of
                            the school year.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="md:col-span-3 md:pl-5">
                ...
                <div class="" data-aos="fade-down-right">
                    <p class="text-xl text-[#dbb055] leading-9">
                        ...
                        created an engaging space that sparked interest and enthusiasm among the students. Introducing
                        and explaining the significance of the traditional costumes helped everyone appreciate and
                        understand our national culture more deeply. The event was not only an opportunity to showcase
                        my creativity as an MC but also allowed me to enhance my communication skills and ability to
                        work under pressure.
                    </p>
                </div>
            </div>
