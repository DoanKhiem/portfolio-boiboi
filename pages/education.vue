<template>
    <h1 class="text-primary abril-fatface-regular-font text-6xl uppercase text-center">Education</h1>
    <div class="grid grid-cols-2">
        ...
        <div>
            <div>
                <h2 class="pacifico-regular-font px-10 py-5 inline-block text-4xl bg-primary text-white rounded-full">Ngo Gia Tu High School</h2>
